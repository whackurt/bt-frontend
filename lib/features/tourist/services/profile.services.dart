...
class TouristProfileServices {
  Api api = Api();

  Future getTouristHome({required String id}) async {
  ...
  Future getTouristProfile({required String id}) async {
    http.Response response =
        await http.get(Uri.parse('${api.touristBaseUrl}/$id/profile'));
  ...
  Future updateTouristProfile({required id, required Map updateData}) async {
    http.Response response =
        await http.put(Uri.parse('${api.touristBaseUrl}/$id/profile/update'),
  ...
  Future updateTouristPhoto({required File? imageFile}) async {
